// props
// data: an array of objects showing path, e.g.:
// [{label:'Home',path:'/'}... ]
    ...
    return (
        <nav className="bg-white border-b border-gray-200 flex" aria-label="Breadcrumb">
            <ol role="list" className="max-w-screen-xl w-full mx-auto px-4 flex space-x-4 sm:px-6 lg:px-8">
                ...
                {props.data.map(obj => <li className="flex" key={obj.path}>
                    <div className="flex items-center">
                        ...
                        <Link href={obj.path}>
                            <a className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{obj.label}</a>
                        </Link>
                    </div>
                </li>)}
